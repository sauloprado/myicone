...
<link rel="shortcut icon" href="icone.gif" type="image/gif" />
...
<table border="0" align="center">
  <tr>
    <td width="600" valign="top" bgcolor="#FFFFFF"><div align="center">
      <p align="center"><img src="estados/imagens/br.jpg" width="600" height="172" /><br />
        SEJA BEM VINDO<br /><!-- INICIO DO CODIGO DO CONTADOR DE VISITAS 2W.COM.BR -->
      <!-- FIM DO CODIGO DO CONTADOR DE VISITAS 2W.COM.BR -->
AO MUNDO DOS &Iacute;CONES.</p>
      <form name="form" id="form">
        <select name="jumpMenu" size="1" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
          <option value="#">Selecione seu estado</option>
          <option value="ac.php">Acre</option>
          <option value="al.php">Alagoas</option>
          <option value="ap.php">Amap&aacute;</option>
          <option value="am.php">Amazonas</option>
          <option value="ba.php">Bahia</option>
          <option value="ce.php">Cear&aacute;</option>
          <option value="df.php">Distrito Federal</option>
          <option value="es.php">Esp&iacute;rito Santo</option>
          <option value="go.php">Go&iacute;as</option>
          <option value="ma.php">Maranh&atilde;o</option>
          <option value="mt.php">Mato Grosso</option>
          <option value="ms.php">Mato Grosso do Sul</option>
          <option value="mg.php">Minas Gerais</option>
          <option value="pa.php">Par&aacute;</option>
          <option value="pb.php">Para&iacute;ba</option>
          <option value="pr.php">Paran&aacute;</option>
          <option value="pe.php">Pernambuco</option>
          <option value="pi.php">Piau&iacute;</option>
          <option value="rj.php">Rio de Janeiro</option>
          <option value="rn.php">Rio Grande do Norte</option>
          <option value="rs.php">Rio Grande do Sul</option>
          <option value="ro.php">Rond&ocirc;nia</option>
          <option value="rr.php">Roraima</option>
          <option value="sc.php">Santa Catarina</option>
          <option value="sp.php">S&atilde;o Paulo</option>
          <option value="se.php">Sergipe</option>
          <option value="to.php">Tocantins</option>
        </select>
      </form>
      <p align="center"><br />
      <span class="style1" style="cursor:hand; color:blue; text-decoration:none" onClick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.myicone.com');">Fa&ccedil;a do Myicone sua p&aacute;gina inicial</span></p>
    </div></td>
  </tr>
</table>
<br />
...
<table width="800" border="0" align="center">
  <tr>
    ...
    <td colspan="4"><table width="820" border="0" align="center">
    ...
    <td valign="top"><a href="page2.php"><img src="imagens/seta1.png" width="67" height="117" border="0" /></a></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td colspan="4">&nbsp;</td>
  ...
  <tr>
    <td valign="top">&nbsp;</td>
    <td colspan="4"><div align="center" class="texto">Responsabilidade Social<br />
<br />
    </div></td>
    <td valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td><div align="center"><a href="http://www.alcoolicosanonimos.org.br/" target="_blank"><img src="rs/aa.jpg" width="62" height="63" border="0" /></a></div></td>
    <td><div align="center"><a href="http://portal.saude.gov.br/portal/saude/area.cfm?id_area=410" target="_blank"><img src="rs/doeorgaos.jpg" width="62" height="62" border="0" /></a></div></td>
    <td><div align="center"><a href="http://www.boldrini.org.br/site/default.asp" target="_blank"><img src="rs/boldrini.jpg" width="62" height="63" border="0" /></a></div></td>
    <td><div align="center"><a href="http://contradrogas.org.br/" target="_blank"><img src="rs/drogas.png" width="62" height="63" border="0" /></a></div></td>
    <td valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td><div align="center"><a href="http://www.alcoolicosanonimos.org.br/" target="_blank">Alco&oacute;licos An&ocirc;nimos</a></div></td>
    <td><div align="center">D<a href="http://portal.saude.gov.br/portal/saude/area.cfm?id_area=410" target="_blank">oe Vida, Doe Org&atilde;os</a></div></td>
    <td><div align="center"><a href="http://www.boldrini.org.br/site/default.asp" target="_blank">Boldrini</a></div></td>
    <td><div align="center">Contra as Drogas</div></td>
    <td valign="top">&nbsp;</td>
  </tr>
</table>
<p>&nbsp;</p>
