...
$totalRows_busca = mysql_num_rows($busca);$colname_busca = "-1";
...
<table border="0" align="center">
  <tr>
    <td width="600" valign="top" bgcolor="#FFFFFF"><div align="center">
      <p align="center"><a href="index.php"><img src="imagens/logonovo.jpg" width="500" height="172" border="0" /></a><br />
...
<table width="820" border="0" align="center">
  <tr>
    <td width="364"><a href="games.php" target="_self"><img src="imagens/games.png" width="146" height="34" border="0" /></a></td>
    ...
    <td><div align="center">
      <?php do { ?>
          <?php if ($totalRows_busca > 0) { // Show if recordset not empty ?>
            <p><a href="<?php echo $row_busca['site_icone']; ?>" target="_blank"><img src="iconesbd/<?php echo $row_busca['icone_icone']; ?>" width="64" height="64" border="0" /></a></p>
            <p><a href="<?php echo $row_busca['nome_icone']; ?>"><?php echo $row_busca['nome_icone']; ?></a></p>
...
<img src="http://contador.kinghost.com.br/contador.cgi?ft=1|df=myicone.br"></div>
<p>&nbsp;</p>
