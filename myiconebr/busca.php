...
$query_busca = sprintf("SELECT * FROM criaricones WHERE nome_icone LIKE %s ORDER BY nome_icone ASC", GetSQLValueString("%" . $colname_busca . "%", "text"));
...
<td><div align="center"><a href="http://www.americanas.com.br/" target="_blank"><img src="icones/americanas.jpg" width="64" height="64" border="0" /></a><br />
  ...
  <tr align="center" valign="top">
    ...
    <td height="3">&nbsp;</td>
    <td height="3"><a href="http://br.altavista.com/" target="_blank"><img src="icones/altavista.jpg" width="64" height="64" border="0" /></a></td>
    <td height="3">&nbsp;</td>
  ...
  <tr align="center" valign="top">
    ...
    <td>&nbsp;</td>
    <td><div align="center"><a href="http://www.adobe.com/br/" target="_blank"><img src="icones/adobe.jpg" width="64" height="64" border="0" /></a><br />
    </div></td>
    <td>&nbsp;</td>
  ...
  <tr align="center" valign="top">
    ...
    <td>&nbsp;</td>
    <td><a href="http://www.adobe.com/br/" target="_blank">Adobe</a></td>
    <td>&nbsp;</td>
