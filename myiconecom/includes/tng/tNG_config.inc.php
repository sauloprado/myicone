...
// Start Variable definitions
  ...
  $tNG_login_config["connection"] = "myicone";
  $tNG_login_config["table"] = "usuario";
  ...
  $tNG_login_config["redirect_failed"] = "users/index.php";
  $tNG_login_config["redirect_success"] = "users/index2.php";
  $tNG_login_config["login_page"] = "users/index.php";
